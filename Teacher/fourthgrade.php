...
<form method=POST action="fourthgrade.php">
		<div class="dashboard">
...
echo "<td class=announcementinfograde>".$row['FILF'];
echo "<td class=announcementinfograde>".$row['ENGF'];
echo "<td class=announcementinfograde>".$row['MATHF'];
echo "<td class=announcementinfograde>".$row['SCIF'];
echo "<td class=announcementinfograde>".$row['APF'];
echo "<td class=announcementinfograde>".$row['TLEF'];
echo "<td class=announcementinfograde>".$row['MAPF'];
echo "<td class=announcementinfograde>".$row['CEF'];
echo "<td class=announcementinfograde>".$row['COMF'];
echo "<td class=announcementinfograde>".$row['TOTALSF'],"%";
echo "<td class=announcementinfograde>".$row['STATUSF'];
echo "<td class=announcementinfograde>".$row['REMARKSF'];
echo "<td class=announcementinfograde> <a href='ent4grade.php?ID=".$row['Stud_SID']."'> Input Grade </a>";
