...
<form method=POST action="secondgrade.php">
		<div class="dashboard">
...
echo "<td class=announcementinfograde>".$row['FILS'];
echo "<td class=announcementinfograde>".$row['ENGS'];
echo "<td class=announcementinfograde>".$row['MATHS'];
echo "<td class=announcementinfograde>".$row['SCIS'];
echo "<td class=announcementinfograde>".$row['APS'];
echo "<td class=announcementinfograde>".$row['TLES'];
echo "<td class=announcementinfograde>".$row['MAPS'];
echo "<td class=announcementinfograde>".$row['CES'];
echo "<td class=announcementinfograde>".$row['COMS'];
echo "<td class=announcementinfograde>".$row['TOTALS'],"%";
echo "<td class=announcementinfograde>".$row['STATUSS'];
echo "<td class=announcementinfograde>".$row['REMARKSS'];
echo "<td class=announcementinfograde> <a href='entsgrade.php?ID=".$row['Stud_SID']."'> Input Grade </a>";
