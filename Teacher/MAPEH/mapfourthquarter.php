...
<link rel="icon" href="/GradingSystem/Images/logo.png">
<link rel="stylesheet" href="/GradingSystem/Css/sepi.css">
...
<form method="POST"action="logout.php" >
	...
	<form method=POST action="mapfourthquarter2.php">
		<div class="dashboard">
			<img src="/GradingSystem/Images/logo.png" class="dashboardlogocvgs">
			<a href="mapdashboard.php" class="Dashboardhome"><img src="/GradingSystem/Images/homeicon.png" class="homeicon">Dashboard</a>
			<a href="mapannounce.php" class="Announcement"><img src="/GradingSystem/Images/announcement.png" class="announcementicon">Announcement</a>
			<a href="mapfirst.php" class="BGradestudent"><img src="/GradingSystem/Images/studrecord.png" class="teachericon">Grades</a>
			<a href="maplist.php" class="BStudentlist"><img src="/GradingSystem/Images/account.png" class="accounticon">Student List</a>
			<a href="mapchangepass.php"  class="BAccounts"><img src="/GradingSystem/Images/account.png" class="accounticon">Accounts</a>
...
<a href="mapfourth.php" class=addstudentback> Back</a>
