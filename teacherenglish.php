...
<div class="container">
		...
		<form method=POST action=teacherenglish.php>
			<div class="container1">
				<h4 id=fonttitle>TEACHER - LOG IN - ENGLISH</h4>
...
<?php
	...
	#$result1 = $config->query($viewloginl);
			 ...
			 if($type == "Teacher" && $subject == "English")
				{
					if($dbpassword == $password)
						{
							header("refresh:0;url=./Teacher/English/engdashboard.php");
						}
						else
						{
							?>
