...
<div class="container">
		...
		<form method=POST action=teacherce.php>
			<div class="container1">
				<h4 id=fonttitle>TEACHER - LOG IN - C.E</h4>
...
<?php
	...
	#$result1 = $config->query($viewloginl);
			 ...
			 if($type == "Teacher" && $subject == "Christian Education")
				{
					if($dbpassword == $password)
						{
							header("refresh:0;url=./Teacher/CE/cedashboard.php");
						}
						else
						{
							?>
