...
const configDB = require('./backend/config/configDB')

/*  initializing packages   */

//requiring routes
const basicRoutes = require('./backend/route/basic')
const authRoutes = require('./backend/route/authenticate')
const userRoutes = require('./backend/route/user')
const adminRoutes = require('./backend/route/admin')
const adminStaff = require('./backend/route/staff')
