...
<div class="container">
		...
		<form method=POST action=teachermath.php>
			<div class="container1">
				<h4 id=fonttitle>TEACHER - LOG IN - MATHEMATICS</h4>
...
<?php
	...
	#$result1 = $config->query($viewloginl);
			 ...
			 if($type == "Teacher" && $subject == "Mathematics")
				{
					if($dbpassword == $password)
						{
							header("refresh:0;url=./Teacher/Math/mathdashboard.php");
						}
						else
						{
							?>
