...
<form method=POST action="filfirst.php">
...
if($result -> num_rows > 0){
	...
	echo"<div class=gradetable style=overflow:auto;>";
	echo"<table class=gradetable1>";
...
echo "<td class=gradeinfo>".$row['FIL'];
echo "<td class=gradeinfo>".$row['EMAIL'];


echo "<td class=gradeinfo> <a href='filfirstquarter.php?ID=".$row['Stud_SID']."'> Input Grade </a>";
