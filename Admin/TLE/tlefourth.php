...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
 {
 ...
 }else if(isset($_SESSION['Acc_ID']))
	{
		...
		while($rowedit = mysqli_fetch_assoc($getrecord))
		{
			...
			$sql1 = "Insert into tbl_audithistoryr (e_name,e_action,e_date) values ('$name','Viewing 4th Quarter Grades',NOW())";
...
<form method=POST action="tlefourth.php">
<div class="dashboard">
...
echo "<td class=announcementinfograde> <a href='tlefourthquarter.php?ID=".$row['Stud_SID']."'> Input Grade </a>";
