...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
 {
 ...
 }else if(isset($_SESSION['Acc_ID']))
	{
		...
		while($rowedit = mysqli_fetch_assoc($getrecord))
		{
			...
			$sql1 = "Insert into tbl_audithistory (e_name,e_action,e_date) values ('$name','Viewing Input 4th Quarter Grade',NOW())";
...
<form method="POST"action="logout.php" >
	...
	<form method=POST action="sciencefourthquarter2.php">
	<div class="dashboard">
		...
		<div class="studgradet">
			<h1 id="studtitle">GRADE FOR SCIENCE</h1>
			...
			<input type=text name=LSCI class=gradesubjectt value="<?php echo $LSCI ; ?>" autofocus>
			<input type=submit name=entgrade class=addstudbtn value="Enter Grade">
			<a href="scifourthquarter.php" class=addstudentback> Back</a>
		</div>
