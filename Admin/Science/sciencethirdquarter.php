...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
 {
 ...
 }else if(isset($_SESSION['Acc_ID']))
	{
		...
		while($rowedit = mysqli_fetch_assoc($getrecord))
		{
			...
			$sql1 = "Insert into tbl_audithistory (e_name,e_action,e_date) values ('$name','Viewing Input 3rd Quarter Grade',NOW())";
...
<form method="POST"action="logout.php" >
	...
	<form method=POST action="sciencethirdquarter2.php">
	<div class="dashboard">
		...
		<div class="studgradet">
			...
			<a href="scithirdquarter.php" class=addstudentback> Back</a>
		</div>
