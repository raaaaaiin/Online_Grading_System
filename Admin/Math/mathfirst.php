...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
 {
 ...
 }else if(isset($_SESSION['Acc_ID']))
	{
		...
		while($rowedit = mysqli_fetch_assoc($getrecord))
		{
			...
			$sql1 = "Insert into tbl_audithistory (e_name,e_action,e_date) values ('$name','Viewing 1st Quarter Grades',NOW())";
...
<form method=POST action="mathfirst.php">
<div class="dashboard">
...
<div class="announcementdiv">
				...
				<input type=submit name=sub class="announcementbtn"><select name=category>
...
<option>Grade 10 - Prosperity</option>
				...
				<a href="mathfirst.php" class="firstquarter">First Quarter</a>
				<a href="mathsecond.php" class="secondquarter">Second Quarter</a>
				<a href="maththird.php" class="thirdquarter">Third Quarter</a>
				<a href="mathfourth.php" class="fourthquarter">Fourth Quarter</a>
...
echo "<td class=announcementinfograde> <a href='mathfirstquarter.php?ID=".$row['Stud_SID']."'> Input Grade </a>";
