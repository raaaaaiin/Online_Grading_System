...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
 {
 ...
 }else if(isset($_SESSION['Acc_ID']))
	{
		...
		while($rowedit = mysqli_fetch_assoc($getrecord))
		{
			...
			$sql1 = "Insert into tbl_audithistory (e_name,e_action,e_date) values ('$name','Viewing 4th Quarter Grades',NOW())";
...
<form method=POST action="cefourth.php">
<div class="dashboard">
...
<option>Grade 10 - Prosperity</option>
				...
				<a href="cefirst.php" class="firstquarter">First Quarter</a>
				<a href="cesecond.php" class="secondquarter">Second Quarter</a>
				<a href="cethird.php" class="thirdquarter">Third Quarter</a>
				<a href="cefourth.php" class="fourthquarter">Fourth Quarter</a>
...
echo "<td class=announcementinfograde>".$row['CEF'];
echo "<td class=announcementinfograde> <a href='cefourthquarter.php?ID=".$row['Stud_SID']."'> Input Grade </a>";
echo "<td class=announcementinfograde> <a href='cefirstquarter.php?ID=".$row['Stud_SID']."'> Input Grade </a>";
