...
<div class="container">
		...
		<form method=POST action=teachertle.php>
			<div class="container1">
				<h4 id=fonttitle>TEACHER - LOG IN - T.L.E</h4>
...
<?php
	...
	#$result1 = $config->query($viewloginl);
			 ...
			 if($type == "Teacher" && $subject == "T.L.E.")
				{
					if($dbpassword == $password)
						{
							header("refresh:0;url=./Teacher/TLE/tledashboard.php");
						}
						else
						{
							?>
