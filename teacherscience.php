...
<div class="container">
		...
		<form method=POST action=teacherscience.php>
			<div class="container1">
				<h4 id=fonttitle>TEACHER - LOG IN - SCIENCE</h4>
...
<?php
	...
	#$result1 = $config->query($viewloginl);
			 ...
			 if($type == "Teacher" && $subject == "Science")
				{
					if($dbpassword == $password)
						{
							header("refresh:0;url=./Teacher/Science/scidashboard.php");
						}
						else
						{
							?>
