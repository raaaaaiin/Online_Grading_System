...
<div class="container">
		...
		<form method=POST action=teachercom.php>
			<div class="container1">
				<h4 id=fonttitle>TEACHER - LOG IN - COMPUTER</h4>
...
<?php
	...
	#$result1 = $config->query($viewloginl);
			 ...
			 if($type == "Teacher" && $subject == "Computer")
				{
					if($dbpassword == $password)
						{
							header("refresh:0;url=./Teacher/COMPUTER/comdashboard.php");
						}
						else
						{
							?>
