		...
		if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true)
		 {
			...
			$sql1 = "Insert into tbl_auditstudent (e_name,e_level,e_action,e_date) values ('$name','$section','Viewing Stundent Dashboard',NOW())";
...
<form method="POST"action="logout.php" >
	...
	<form method=POST action="dashboardstudent.php">
<div class="dashboard">
